...
| `ao svc` | Services | Start, stop, list services (`systemctl`) | ✅ Implemented | Debian/Ubuntu, Fedora, Arch Linux (Systemd) |
...
| `ao pkg` | Packages | Install, remove, update | ✅ Implemented | Debian/Ubuntu (`apt`), Fedora (`dnf`), Arch Linux (`pacman`) |
