Add a hotkey to switch between interfaces for the network chart. show the currently used interface. filter tx and rx traffic shown in the chart to the currently selected interface.
show also fan speed in the sensors tab.
support also podman and lxc in the virtualization tab
when presing enter on a service in the service tab, open the service details tab that shows the log for the service, and also hotkeys to start/stop/restart the service.
